...
bool param_t::getBoolFlag(string flag)
{
  ...
  cerr << "ERROR: There are no bool flags.\n";
  throw 0;
}
...
double param_t::getDoubleFlag(string flag)
{
  ...
  cerr << "ERROR: There are no double flags.\n";    
  throw 0;
}
...
int param_t::getIntFlag(string flag)
{
  ...
  cerr << "ERROR: There are no int flags.\n";
  throw 0;
}
...
char param_t::getCharFlag(string flag)
{
  ...
  cerr << "ERROR: There are no char flags.\n";
  throw 0;
}
...
string param_t::getStringFlag(string flag)
{
  ...
  cerr << "ERROR: There are no string flags.\n";
  throw 0;
}
